...
class ControlPanel(QtWidgets.QFrame):
    ...
    def _show_camera_info_popup(self) -> None:
        ...
        msg_box.setStyleSheet("QLabel { color: #000000; } QPushButton { color: #000000; }")
        msg_box.exec()
...
class BeamProfilerApp(QtWidgets.QMainWindow):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.setWindowTitle("IDS Beamprofiler")
        ...
        self._slice_mode = "cursor"  # "sum", "cursor", or "peak"
        ...
        self.statusBar().showMessage("Starting IDS beamprofiler...")
